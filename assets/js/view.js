 ...
 * Versão: 1.1.0 - Atualização PWA e Gestão de Ciclos
 */
            ...
            <div class="${containerClass} p-4 rounded-lg border-l-4 border-l-indigo-600 mb-3 transition-all relative group">
                ...
                <div class="flex justify-between items-end pt-2 border-t border-stone-100">
                    ...
                    <div class="flex items-center gap-3">
                         ...
                         <button onclick="app.openDeleteModal('${review.id}', '${review.batchId || ''}')" class="text-stone-300 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity">
